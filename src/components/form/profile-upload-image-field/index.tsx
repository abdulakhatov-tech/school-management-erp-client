          ...
          <div className='relative'>
            <img
              ...
              className={classNames(
                "object-cover rounded-full w-[200px] h-[200px] md:w-[220px] md:h-[220px] border border-solid",
                {
            ...
            <div
              ...
              className={classNames(
                "flex items-center justify-center absolute right-1 bottom-5 z-10 w-9 h-9 rounded-full overflow-hidden bg-[#F6F6F6] custom-shadow",
                {
                  "input-error focus-visible:ring-transparent":
                    meta.touched && meta.error,
                }
            ...
            >
              {uploading ? (
                <LoadingSpinner className='text-[24px] text-black' size='sm' />
              ) : (
                <IoIosCamera className='text-[25px] text-[#6C6C6C]' />
              )}
            </div>
            <Input
              ref={inputRef}
